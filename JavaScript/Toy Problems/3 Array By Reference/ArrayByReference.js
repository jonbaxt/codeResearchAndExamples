...
var oldInventory = [
  ...
  console.log('countInventory:', countInventory(oldInventory));   // This is working fine.


  // All of the animals were very popular and were all sold in the past week
  // these same animals were ordered for the next week
  var newInventory = oldInventory.slice(); //Create a shallow copy instead of reference to oldInventory to keep data immutable.
  ...
  // New ones being added in sample data for compare should be 4 new ones.

  //Added Slice method to newArr to allow shallow copy of old array.